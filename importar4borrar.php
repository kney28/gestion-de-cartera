...
$total_pagos = $conn->get_var('SELECT count(*) FROM pagos,facturas where num_factura_pagos=numero_factura');
$resultados   = 16;
...
$paises = $conn->get_results('SELECT * FROM pagos,facturas where num_factura_pagos=numero_factura LIMIT ' . (($paginacion->get_page() - 1) * $resultados) . ', ' . $resultados);
?>
