...
<form name="form1" method="post" action="">
  <input type="submit" name="button" value="Cruzar Base de Datos" class="btn-primario">
  <input type="checkbox" name="validar" id="validar" required title="Marque para cruzar la base de datos"> 
  Validar
  </section>
</h4>
<br>
